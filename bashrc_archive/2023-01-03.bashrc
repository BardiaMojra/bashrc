...
# then git pull, git add [staged file], gitexpress
...
alias getpyproj='cp -r ~/git/cheatsheets/py_proj/* .'
alias getmatlabproj='cp -r ~/git/cheatsheets/matlab_proj/* .'
alias gettexproj='cp -r ~/git/cheatsheets/tex_proj/* .'
#alias gigros
