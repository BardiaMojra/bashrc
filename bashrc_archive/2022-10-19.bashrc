...
alias ugitexpress="git add -A && git commit -m 'Updated with git-express on $(date +%F).' &&\
...
alias gitreset='git reset --mixed HEAD~1'  # undo the last commit and keep changes
...
#alias giglabview
#alias gigobjc
alias gigunity='cp ~/git/cheatsheets/gitignores/global/Unity.gitignore ./unity.gitignore'
#alias gigue
#alias gigvs
...
alias getpyproj='cp ~/git/cheatsheets/py_proj/* .'
alias getmatlabproj='cp ~/git/cheatsheets/matlab_proj/* .'
alias gettexproj='cp ~/git/cheatsheets/tex_proj/* .'
#alias gigros
